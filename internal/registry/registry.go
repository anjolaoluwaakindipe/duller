...
type Registry interface {
	...
	RegisterService(msg *service.ServiceInfo) error
	// GetServiceById takes in an ID  and returns its corresponding service.
	GetServiceById(serviceId string) (*service.ServiceInfo, error)
	...
	// is no error
	GetServicesByPath(path string) ([]*service.ServiceInfo, error)
	// Returns all available services in Registry
	GetServices() []*service.ServiceInfo
